...
################################################################
### Gabriella Pardee, Sean Griffin, Michael Stemkovski #########
################################################################
...
#com <- read.csv (file = "~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingLocation/PhyloTreeR_27May2019NestLocation.csv", header=FALSE)
#no bombus
com <- read.csv (file = "~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingLocation/PhyloTreeR_27May2019NestLocationNoBombus.csv", header=FALSE)
...
#Com=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingLocation/Abundance_matrix_27May2019_NestLocation.csv",header=TRUE)
#No Bombus
Com=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingLocation/Abundance_matrix_27May2019_NestLocationNoBombus.csv",header=TRUE)
...
#Trait=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingLocation/Traits_Matrix_27May2019_NestLocation.csv",header=TRUE)
#No Bombus
Trait=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingLocation/Traits_Matrix_27May2019_NestLocationNoBombus.csv",header=TRUE)
...
write.csv(Fourthcorner1$TabD2, file="NestLocationOutputD2NoBombus.csv")

print(Fourthcorner1$TabG)
write.csv(Fourthcorner1$TabG, file="NestLocationTabGNoBombus.csv")

print(Fourthcorner1$TabD)
write.csv(Fourthcorner1$TabD,file="NestLocationTabDNoBombus.csv")
