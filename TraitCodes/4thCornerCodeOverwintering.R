...
#updated on 5 August 2021 with data Zach checked over. Did a test where I combined all Melissodes into one species "Melissodes_sp" to see whether getting a bee ID'ed to genus affects the data at all. Zach suggested I do this and I think he had a good point
...
#all species, including bees only Id'ed to genus...updated with Zach checked file
#com <- read.csv (file = "~/Dropbox/fourth corner paper/4th corner codes/updated analysis/Overwintering/ZachChecked/PhyloTreeR_29June2021_Overwintering_12August.csv", header=FALSE)
#no bombus
com <- read.csv (file = "~/Dropbox/fourth corner paper/4th corner codes/updated analysis/Overwintering/ZachChecked/PhyloTreeR_29June2021_Overwintering_12AugustNoBombus.csv", header=FALSE)

#test with Melissodes
#com <- read.csv (file = "~/Dropbox/fourth corner paper/4th corner codes/updated analysis/Overwintering/ZachChecked/PhyloTreeR_29June2021_OverwinteringNoMelTest.csv", header=FALSE)

#excluding bees ID'ed to genus
#com <- read.csv (file = "~/Dropbox/fourth corner paper/4th corner codes/updated analysis/Overwintering/PhyloTreeR_27May2019_Overwintering_no_sp.csv", header=FALSE)
...
#Step 3: run 4th corner analysis

#download permute package
library(ade4)
#Com is community, with site/years as rows, species as columns, abundance data
#all species, including bees only ID'ed to genus...Zach checked 
#Com=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/Overwintering/ZachChecked/Abundance_matrix_30June2021_Overwintering_12August.csv",header=TRUE)
#no bombus, but Zach checked
Com=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/Overwintering/ZachChecked/Abundance_matrix_30June2021_Overwintering_12AugustNoBombus.csv",header=TRUE)

#test with Melissodes 
#Com=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/Overwintering/ZachChecked/Abundance_matrix_30June2021_Overwintering_NoMelTest.csv",header=TRUE)
#excluding bees ID'ed to genus
#Com=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/Overwintering/Abundance_matrix_27May2019_Overwintering_no_sp.csv",header=TRUE)
...
#all species, including bees only ID'ed to genus...Zach checked
#Trait=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/Overwintering/ZachChecked/Traits_Matrix_29June2021_Overwintering_12August.csv",header=TRUE)
#No Bombus...Zach checked
Trait=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/Overwintering/ZachChecked/Traits_Matrix_29June2021_Overwintering_12AugustNoBombus.csv",header=TRUE)

#melissodes test
#Trait=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/Overwintering/ZachChecked/Traits_Matrix_29June2021_OverwinteringNoMelTest.csv",header=TRUE)

#excluding bees ID'ed to genus
#Trait=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/Overwintering/Traits_Matrix27May2019_Overwintering_no_sp.csv",header=TRUE)
...
write.csv(Fourthcorner1$TabD2, file="OverwinteringD2_ZachCheckedNoBombus.csv")
print(Fourthcorner1$TabG)
write.csv(Fourthcorner1$TabG, file="OverwinteringTabG_ZachCheckedNoBombus.csv")
