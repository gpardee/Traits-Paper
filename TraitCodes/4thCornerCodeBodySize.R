...
com <- read.csv (file = "~/Dropbox/fourth corner paper/4th corner codes/updated analysis/ITD/PhyloTreeR_30August2019_ITD.csv", header=FALSE)
#No Bombus
#com <- read.csv (file = "~/Dropbox/fourth corner paper/4th corner codes/updated analysis/ITD/PhyloTreeR_30August2019_ITDNoBombus.csv", header=FALSE)
#excluding bees only ID'ed to genus
#com <- read.csv (file = "~/Dropbox/fourth corner paper/4th corner codes/updated analysis/ITD/PhyloTreeR_30August2019_ITD_no_sp.csv", header=FALSE)
...
#full community, including bees ID'ed only to genus
Com=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/ITD/Abundance_matrix_30Aug2019_ITD.csv",header=TRUE)

#No Bombus
#Com=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/ITD/Abundance_matrix_30Aug2019_ITDNoBombus.csv",header=TRUE)

#Excluding bees only ID'ed to genus level
#Com=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/ITD/Abundance_matrix_30Aug2019_ITD_no_sp.csv",header=TRUE)
...
#all bees, including bees only ID'ed to genus
Trait=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/ITD/Traits_Matrix_30August2019_ITD.csv",header=TRUE)
#No bombus
#Trait=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/ITD/Traits_Matrix_30August2019_ITDNoBombus.csv",header=TRUE)
#excluding bees only ID'ed to genus
#Trait=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/ITD/Traits_Matrix_30August2019_ITD_no_sp.csv",header=TRUE)

#Mass
#Trait=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/ITD/Traits_Matrix_30August2020_Mass.csv",header=TRUE)
...
Fourth.corner <- function(Trait, Its = 9999) {
  ...
  #source("~/Documents/R_analysis/Fourth corner/phylogenetic_permutation_functions.R")
...
summary(Fourthcorner1$TabD2)
write.csv(Fourthcorner1$TabD2, file="ITDOutputD2ContDrought.csv")
print(Fourthcorner1$TabG)
write.csv(Fourthcorner1$TabG, file="ITDOutputTabGContDrought.csv")
