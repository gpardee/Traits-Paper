...
#Zach updated file
#com <- read.csv (file = "~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingSubstrate/Zach_checked/PhyloTreeR_29June2021_Nesting.csv", header=FALSE)

#no bombus...Zach checked
com <- read.csv (file = "~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingSubstrate/Zach_checked/PhyloTreeR_29June2021_NestingSubstrate_NoBombus.csv", header=FALSE)
#excluding bees only Id'ed to genus
#com <- read.csv (file = "~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingSubstrate/PhyloTreeR_27May2019NestingSubstrateRockExcluded_no_sp.csv", header=FALSE)
...
#all species, including nes only ID'ed to genus
#Zach updated
#Com=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingSubstrate/Zach_checked/Abundance_matrix_30June2021_Substrate.csv",header=TRUE)

#NoBombus Zach checked
Com=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingSubstrate/Zach_checked/Abundance_matrix_30June2021_Substrate_NoBombus.csv",header=TRUE)
#excluding bees only Id'ed to genus
#Com=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingSubstrate/Abundance_matrix_27May2019NestingSubstrate_RockExcluded_no_sp.csv",header=TRUE)
...
#all bees, including bees only Id'ed to genus
#zach update
#Trait=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingSubstrate/Zach_checked/Traits_Matrix_29June2021_Substrate.csv",header=TRUE)

#no bombus... zach update
Trait=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingSubstrate/Zach_checked/Traits_Matrix_29June2021_Substrate_NoBombus.csv")

#excluding bees only ID'ed to genus
#Trait=read.csv("~/Dropbox/fourth corner paper/4th corner codes/updated analysis/NestingSubstrate/Traits_Matrix_27May2019_NestingSubstrate_ExcludedRock_no_sp.csv",header=TRUE)
...
write.csv(Fourthcorner1$TabD2, file="SubstrateFinal_TabDZachUpdateNoBombus.csv")

print(Fourthcorner1$TabG)
write.csv(Fourthcorner1$TabG, file="SubstrateFinalTabG_ZachUpdateNoBombus.csv")
